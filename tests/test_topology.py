...
class TopologyTestCase(unittest.TestCase):
    ...
    def test_topology_exact_duplicate_lines_abc_and_abc_share_the_arc_ABC(self):
    ...
    def test_topology_reversed_duplicate_lines_abc_and_cba_share_the_arc_abc(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_an_old_arc_abc_extends_a_new_arc_ab_they_share_the_arc_ab(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_reversed_old_arc_cba_extends_a_new_arc_ab_they_share_the_arc_ba(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[2, 0], [1, 0], [0, 0]]
    ...
    def test_topology_when_a_new_arc_ade_shares_its_start_with_an_old_arc_abc_they_dont_share_arcs(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_new_arc_dec_shares_its_start_with_an_old_arc_abc_they_dont_share_arcs(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_new_arc_abc_extends_an_old_arc_ab_they_share_the_arc_ab(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0]]
    ...
    def test_topology_when_a_new_arc_abc_extends_a_reversed_old_arc_ba_they_share_the_arc_ba(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[1, 0], [0, 0]]
    ...
    def test_topology_when_a_new_arc_starts_bc_in_the_middle_of_an_old_arc_abc_they_share_the_arc_bc(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_new_arc_bc_starts_in_the_middle_of_a_reversed_old_arc_cba_they_share_the_arc_cb(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[2, 0], [1, 0], [0, 0]]
    ...
    def test_topology_when_a_new_arc_abd_deviates_from_an_old_arc_abc_they_share_the_arc_ab(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_new_arc_abd_deviates_from_a_reversed_old_arc_cba_they_share_the_arc_ba(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[2, 0], [1, 0], [0, 0]]
    ...
    def test_topology_when_a_new_arc_dbc_merges_into_an_old_arc_abc_they_share_the_arc_bc(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_new_arc_dbc_merges_into_a_reversed_old_arc_cba_they_share_the_arc_cb(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[2, 0], [1, 0], [0, 0]]
    ...
    def test_topology_when_a_new_arc_dbe_shares_a_single_midpoint_with_an_old_arc_abc_they_share_the_point_b_but_no_arcs(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0]]
    ...
    def test_topology_when_a_new_arc_abde_skips_a_point_with_an_old_arc_abcde_they_share_arcs_ab_and_de(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
    ...
    def test_topology_when_a_new_arc_abde_skips_a_point_with_a_reversed_old_arc_edcba_they_share_arcs_ba_and_ed(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
    ...
    def test_topology_when_an_old_arc_abcdbe_self_intersects_and_shares_a_point_b_the_old_arc_has_multiple_cuts(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [2, 0], [3, 0], [1, 0], [4, 0]]
    ...
    def test_topology_exact_duplicate_closed_lines_abca_and_abca_share_the_arc_abca(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [0, 1], [0, 0]]
    ...
    def test_topology_reversed_duplicate_closed_lines_abca_and_acba_share_the_arc_abca(self):
        topology = self.topology({
            'foo': {
                'type': 'LineString',
                'coordinates': [[0, 0], [1, 0], [0, 1], [0, 0]]
    ...
    def test_topology_coincident_reversed_closed_polygons_abca_and_bacb_share_the_arc_bcab(self):
        topology = self.topology({
            'abca': {
                'type': 'Polygon',
                'coordinates': [[[0, 0], [1, 0], [0, 1], [0, 0]]]
    ...
    def test_topology_input_objects_are_mapped_to_topology_objects(self):
        ...
        self.assertEquals(topology['objects']['foo']['type'], 'LineString')
        self.assertEquals(topology['objects']['bar']['type'], 'Polygon')
    ...
    def test_topology_feature_collections_are_mapped_to_geometry_collections(self):
        ...
        self.assertEquals(topology['objects']['collection']['type'], 'GeometryCollection')
        self.assertEquals(len(topology['objects']['collection']['geometries']), 2)
        self.assertEquals(topology['objects']['collection']['geometries'][0]['type'], 'LineString')
        self.assertEquals(topology['objects']['collection']['geometries'][1]['type'], 'Polygon')
    ...
    def test_topology_nested_geometry_collections(self):
        ...
        self.assertEquals(len(topology['objects']['collection']['geometries'][0]['geometries'][0]['arcs']), 1)
    ...
    def test_topology_null_geometry_objects_are_preserved_in_geometry_collections(self):
        ...
        self.assertEquals(topology['objects']['collection']['type'], 'GeometryCollection')
        self.assertEquals(len(topology['objects']['collection']['geometries']), 2)
        self.assertEquals(topology['objects']['collection']['geometries'][0]['type'], None)
        self.assertEquals(topology['objects']['collection']['geometries'][1]['type'], 'Polygon')

    def test_topology_features_with_null_geometry_objects_are_preserved_in_feature_collections(self):
        topology = self.topology({
            'collection': {
                'type': 'FeatureCollection',
                'features': [
    ...
    def test_topology_converting_a_feature_to_a_geometry_preserves_its_id(self):
        ...
        self.assertEquals(topology['objects']['foo']['type'], 'LineString')
        self.assertEquals(topology['objects']['foo']['id'], 42)
    ...
    def test_topology_converting_a_feature_to_a_geometry_preserves_its_properties_but_only_if_non_empty(self):
        topology = self.topology({
            'foo': {
                'type': 'Feature',
                'id': 'Foo',
        ...
        self.assertEqual(
            None,
            topology['objects']['foo'].get('properties', None)
        )

    def test_topology_the_returned_transform_exactly_encompasses_the_input_geometry(self):
        """
    ...
    def test_topology_coincident_points_are_removed(self):
        ...
        topology = self.topology({
            'foo': {
                'type': 'Polygon',
                'coordinates': [
                    [[1/8, 1/16], [1/2, 1/16], [1/2, 1/16], [1/2, 1/4], [1/8, 1/4], [1/8, 1/4], [1/8, 1/16]]
                ]
            }
        }, 2)
        self.assertListEqual([[0, 0], [1, 0], [0, 1], [-1, 0], [0, -1]], topology['arcs'][0])
    ...
    def test_topology_collapsed_lines_in_a_multilinestring_are_preserved(self):
        topology = self.topology({
            'foo': {
                ...
                'coordinates': [
                    [[1/8, 1/16], [1/2, 1/4]], [[1/8, 1/16], [1/8, 1/16]], [[1/2, 1/4], [1/8, 1/16]]
                ]
            }
        }, 2)
        self.assertEquals(len(topology['arcs']), 2)
    ...
    def test_topology_the_lines_acdf_and_bcdf_share_three_arcs(self):
        ...
        self.assertDictEqual({
            'type': 'LineString',
            'arcs': [0, 1]
        }, topology['objects']['acdf'])
        self.assertDictEqual({
            'type': 'LineString',
            'arcs': [2, 1]
        }, topology['objects']['bcdf'])
    ...
    def test_topology_the_lines_bcde_and_bcdf_share_three_arcs(self):
        ...
        self.assertDictEqual({'type': 'LineString', 'arcs': [0, 1]}, topology['objects']['bcde'])
        self.assertDictEqual({'type': 'LineString', 'arcs': [0, 2]}, topology['objects']['bcdf'])
    ...
    def test_topology_the_lines_acde_acdf_bcde_and_bcdf_and_their_reversals_share_five_arcs(self):
        """
        ...
        self.assertDictEqual(topology['objects']['acde'], {'type': 'LineString', 'arcs': [0, 1, 2]})
        self.assertDictEqual(topology['objects']['acdf'], {'type': 'LineString', 'arcs': [0, 1, 3]})
        self.assertDictEqual(topology['objects']['bcde'], {'type': 'LineString', 'arcs': [4, 1, 2]})
        self.assertDictEqual(topology['objects']['bcdf'], {'type': 'LineString', 'arcs': [4, 1, 3]})
        self.assertDictEqual(topology['objects']['edca'], {'type': 'LineString', 'arcs': [~2, ~1, ~0]})
        self.assertDictEqual(topology['objects']['fdca'], {'type': 'LineString', 'arcs': [~3, ~1, ~0]})
        self.assertDictEqual(topology['objects']['edcb'], {'type': 'LineString', 'arcs': [~2, ~1, ~4]})
        self.assertDictEqual(topology['objects']['fdcb'], {'type': 'LineString', 'arcs': [~3, ~1, ~4]})
    ...
    def test_topology_the_polygons_abcda_and_befcb_share_three_arcs(self):
        ...
        self.assertDictEqual(topology['objects']['abcda'], {'type': 'Polygon', 'arcs': [[0, 1]]})
        self.assertDictEqual(topology['objects']['befcb'], {'type': 'Polygon', 'arcs': [[2, ~0]]})
    ...
    def test_topology_the_polygons_abcda_and_abca_share_three_arcs(self):
        ...
        self.assertDictEqual(topology['objects']['abcda'], {'type': 'Polygon', 'arcs': [[0, 1]]})
        self.assertDictEqual(topology['objects']['abca'], {'type': 'Polygon', 'arcs': [[0, 2]]})
    ...
    def test_topology_the_lines_abcde_and_abde_share_two_arcs(self):
        ...
        self.assertDictEqual(topology['objects']['abcde'], {'type': 'LineString', 'arcs': [0, 1, 2]})
        self.assertDictEqual(topology['objects']['abde'], {'type': 'LineString', 'arcs': [0, 3, 2]})
    ...
    def test_topology_the_polygons_abca_acda_and_bfcb_share_five_arcs(self):
        ...
        self.assertDictEqual({
            'type': 'Polygon',
            'arcs': [[0, 1, 2]]
        }, topology['objects']['abca'])
        self.assertDictEqual({
            'type': 'Polygon',
            'arcs': [[~2, 3]]
        }, topology['objects']['acda'])
        self.assertDictEqual({
            'type': 'Polygon',
            'arcs': [[4, ~1]]
        }, topology['objects']['bfcb'])
    ...
    def test_topology_the_polygons_abcda_abefgda_and_befgdcb_share_three_arcs(self):
        ...
        self.assertDictEqual({
            'type': 'Polygon',
            'arcs': [[2, 1]]
        }, topology['objects']['abefgda'])
        self.assertDictEqual({
            'type': 'Polygon',
            'arcs': [[2, ~0]]
        }, topology['objects']['befgdcb'])
    ...
    def test_topology_the_polygon_bcdb_and_the_line_string_abe_share_three_arcs(self):
        ...
        self.assertDictEqual({
            'type': 'LineString',
            'arcs': [0, 1]
        }, topology['objects']['abe'])
        self.assertDictEqual({
            'type': 'Polygon',
            'arcs': [[2]]
        }, topology['objects']['bcdb'])

# sed -e "s/var \(.*\) =/\1 =/g;s/\/\//#/g;s/;//g;s/test.end()//g;s/test./self./g;s/deepEqual/assertDictEqual/g;s/[^self]\.\(\w*\)/['\1']/g;s/\"/'/g;s/\(\w*\):/'\1':/g;s/topojso\['topology'\]/self.topology/g;s/topolog\[/topology[/g" to.js > clean
